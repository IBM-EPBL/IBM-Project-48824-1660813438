...
@app.route('/')
def home():
    message = "TEAM ID : PNT2022TMID52279" +" "+ "BATCH ID : B1-1M3E "
    return render_template('welcome.html',mes=message)
...
def admin():
    ...
    return render_template("adminlog.html",complaint=users,users=userdatabase,agents=agent,message=user[0],issue=count[0],msgagent = cot[0])
